...
export function NavigationLight() {
  ...
  return (
    <nav className="absolute top-0 font-grift w-full py-8 z-30 bg-transparent ">
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "text-primary-background hover:text-[#F05A29] transition duration-300 ease-in-out font-medium"
                    )}
                  >
                    {item.name}
                  </Link>
