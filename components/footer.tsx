...
export function Footer() {
  return (
    ...
    <footer className="  bg-white pt-70 overflow-hidden relative ">
...
>
  ...
  <span className="relative z-10">Book a Call</span>
      ...
      <div className="info bg-primary  gap-4 text-white mt-2 uppercase font-bold font-grift p-6 px-20  w-full  z-40 relative ">
