    ...
    <>
      <div className="bg-primary">
        <div className="container mx-auto flex flex-col items-center gap-8 pt-36">
          ...
          <h1 className="text-primary-foreground font-grift max-w-5xl px-4 text-center text-6xl leading-28 font-bold md:px-0 md:text-7xl lg:text-8xl">
            <span className="text-primary-foreground/70">The all-in-one</span>
            <br />
            Digital solution <br /> to build you bussiness
      ...
      <section className="py-24 space-y-24">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-12">
            ...
            <div className="flex items-center justify-center overflow-hidden rounded-2xl bg-[url('/bento-grid/lp_bannerResponsive.webp')] p-8 md:col-span-4 row-span-2 bg-cover bg-center">
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-slate-950">
                  Responsive and retina ready images.
                </h3>
                <p className="text-sm text-slate-700">
                  Deliver a perfect website experience with high-resolution
                  images and graphics.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 md:col-span-4">
              ...
              <p className="mb-8 text-sm text-slate-700">
                Olio is a highly performant WordPress theme with good defaults
                and well optimized source code to make your site fast and SEO
                optimized.
              </p>
            ...
            <div className="flex flex-col justify-between rounded-2xl bg-linear-to-br from-blue-600 to-purple-600 p-8 text-white md:col-span-4">
              <div>
                ...
                <p className="mb-8 text-sm text-white/90">
                  Use pre-made translations or customize your website for
                  multiple languages.
                </p>
              </div>
              <div className="space-y-2">
